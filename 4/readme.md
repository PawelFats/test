...
Предложения по рефакторингу: создать общий базовый класс “Фигура”, а для каждой конретной фигуры — свой класс-наследник с собственными уникальными методами. В таком случае, для добавления новой фигуры, нужно будет только создать новый класс(этой фигуры) и его методы.
